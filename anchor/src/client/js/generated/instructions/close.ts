...
export type CloseInput<
  ...
  TAccountLendingdapp extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountLendingdapp>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountLendingdapp> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.lendingdapp),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountLendingdapp>;
